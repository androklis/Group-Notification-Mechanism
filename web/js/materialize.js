            ...
            a(document).ready(function () {
                ...
                a(document).on("change", h, function (b) {
                    ...
                    if (c.hasClass("autocomplete")) {
                        ...
                        if ("" === d)
                            return !1;
                        for (var f = '<ul class="autocomplete-content hide">', g = 0; g < d.length; g++)
                            f += "" !== d[g].path && "" !== d[g]["class"] ? '<li class="autocomplete-option"><img src="' + d[g].path + '" class="' + d[g]["class"] + '"><span>' + d[g].value + "</span></li>" : '<li class="autocomplete-option"><span>' + d[g].value + "</span></li>";
                        f += "</ul>", e.append(f), a(document).on("keyup", c, function () {
                            var d = c.val().trim(),
                                    e = a(".autocomplete-content");
                            "" != d ? (e.children("li").addClass("hide"), e.children("li").filter(function () {
                                return e.removeClass("hide"), c.hasClass("highlight-matching") && b(d), -1 !== a(this).text().indexOf(d)
                            }).removeClass("hide")) : e.children().addClass("hide")
