(function ($) {
  $(document).ready(function() {
    ...
    window.index.add({
      href: 'http://localhost:8081/breadcrumbs.html',
      title: 'Breadcrumbs',
      body: 'There are 3 main button types described in material design. The raised button is a standard button that signify actions and seek to give depth to a mostly flat page. The floating circular action button is meant for very important functions. Flat buttons are usually used within elements that already have depth like cards or modals.'
    });

    window.index.add({
      href: 'http://localhost:8081/cards.html',
      title: 'Cards',
    ...
    window.index.add({
      href: 'http://localhost:8081/chips.html',
      title: 'Chips',
    ...
    window.index.add({
      href: 'http://localhost:8081/collapsible.html',
      title: 'Collapsible',
    ...
    window.index.add({
      href: 'http://localhost:8081/collections.html',
      title: 'Collections',
      body: 'Collections allow you to group list objects together.'
    });

    window.index.add({
      href: 'http://localhost:8081/color.html',
      title: 'Color',
    ...
    window.index.add({
      href: 'http://localhost:8081/dialogs.html',
    ...
    window.index.add({
      href: 'http://localhost:8081/dropdown.html',
      title: 'dropdown',
      body: 'Add a dropdown list to any button.'
    });

    window.index.add({
      href: 'http://localhost:8081/footer.html',
      title: 'footer',
    ...
    window.index.add({
      href: 'http://localhost:8081/forms.html',
    ...
    window.index.add({
      href: 'http://localhost:8081/fullscreen-slider-demo.html',
      title: 'Fullscreen slider demo',
      body: 'Fullscreen slider demo'
    });

    window.index.add({
      href: 'http://localhost:8081/getting-started.html',
      title: 'Getting Started',
      body: 'Learn how to easily start using Materialize in your website.'
    });

    window.index.add({
      href: 'http://localhost:8081/grid.html',
      title: 'Grid',
    ...
    window.index.add({
      href: 'http://localhost:8081/helpers.html',
      title: 'Helpers',
      body: 'helper classes'
    });

    window.index.add({
      href: 'http://localhost:8081/icons.html',
      title: 'icons',
      body: 'We have included 740 Material Design Icons courtesy of Google'
    });

    window.index.add({
      href: 'http://localhost:8081/media-css.html',
      title: 'Media CSS',
      body: 'Media CSS classes'
    });

    window.index.add({
      href: 'http://localhost:8081/media.html',
    ...
    window.index.add({
      href: 'http://localhost:8081/preloader.html',
      title: 'preloader',
    ...
    window.index.add({
      href: 'http://localhost:8081/pushpin.html',
      title: 'Pushpin',
    ...
    window.index.add({
      href: 'http://localhost:8081/shadow.html',
      title: 'shadow',
    ...
    window.index.add({
      href: 'http://localhost:8081/showcase.html',
      title: 'showcase',
      body: 'Here is our showcase of websites that use materialize.'
    });

    window.index.add({
      href: 'http://localhost:8081/side-nav.html',
    ...
    window.index.add({
      href: 'http://localhost:8081/table.html',
      title: 'table',
    ...
    window.index.add({
      href: 'http://localhost:8081/tabs.html',
      title: 'tabs',
    ...
    $('input#search').bind('keyup', debounce(function (e) {
      ...
      var results = window.index.search(query).slice(0, 6).map(function (result) {
        var href = result.ref.split('http://localhost:8081/')[1];
