...
//            $('#nav-mobile').append('<li style="text-align: center;"><img alt="" src="' + img + '" style="vertical-align: middle; border-radius: 25px; width:50px; height:50px;"/></li><li style="color: black; text-align: center;"><strong>' + name + '</strong></li><li style="text-align: center;"><a href="javascript:void(0);" class="waves-effect waves-light" onclick="appSettings();">Settings</a></li><li style="text-align: center;"><a href="#!" class="waves-effect waves-light light-blue-text" onclick="signOut();">Sign Out</a></li><li><a href="http://master-thesis-954.appspot.com/topics.jsp" class="waves-effect waves-light">iSTLab Content Aggregator</a></li><li><a href="http://1-dot-ktistak-calendar-md.appspot.com/" class="waves-effect waves-light">iSTLab Calendar</a></li>');
            $('#nav-mobile').append('<li style="text-align: center;"><img alt="" src="' + img + '" style="vertical-align: middle; border-radius: 25px; width:50px; height:50px;"/></li><li style="color: black; text-align: center;"><a href="https://myaccount.google.com/" target="_blank"><strong>' + name + '</strong></a></li><li><a style="color: black; text-align: center;" href="https://www.google.com/accounts/Logout?continue=https://accounts.google.com/AccountChooser?continue=https://appengine.google.com/_ah/logout?continue=http://group-notification-mechanism.appspot.com/"> Change account </a></li><li style="text-align: center;"><a href="#!" class="waves-effect waves-light light-blue-text" onclick="signOut();">Sign Out</a></li><li><a href="https://docs.google.com/forms/d/1QfU866lVuo4G6UMHDE5hknfMF325fHtK_3MfCeIsmMI/viewform" class="waves-effect waves-light" target="_blank">Report a bug</a></li><li><a href="http://master-thesis-954.appspot.com/topics.jsp" class="waves-effect waves-light" target="_blank">iSTLab Content Aggregator</a></li><li><a href="http://1-dot-ktistak-calendar-md.appspot.com/" class="waves-effect waves-light" target="_blank">iSTLab Calendar</a></li>');
